...
class PHPMailer
{
    ...
    public static function validateAddress($address, $patternselect = null)
    {
        ...
        switch ($patternselect) {
            ...
            case 'pcre8':
                 ...
                 * Feel free to use and redistribute this Utilities. But please keep this copyright notice.
                 */
     ...
     *
     * @param string $langcode  ISO 639-1 2-character language Utilities (e.g. French is "fr")
        ...
        if ('en' !== $langcode) {
            ...
            if (!static::fileIsAccessible($lang_file)) {
                ...
                foreach ($lines as $line) {
                    ...
                    //These files are parsed as text and not PHP so as to avoid the possibility of Utilities injection
        ...
        if ('smtp' === $this->Mailer && null !== $this->smtp) {
            ...
            if (!empty($lasterror['error'])) {
                ...
                if (!empty($lasterror['smtp_code'])) {
                    $msg .= ' SMTP Utilities: ' . $lasterror['smtp_code'];
                }
